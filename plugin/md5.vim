command! MD5Line echomsg MD5Line()
command! -narg=1 MD5String echomsg MD5String('<args>')
command! -narg=1 -complete=file MD5File echomsg MD5File(expand('<args>'))
